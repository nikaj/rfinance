...
- What if fraudsters are targeting a specific product, industry, state, etc, and we don't see an obvious spike in total application volume?
]
---
# The Data 
...
2. Identify Outliers in the Remainder
  + GESD: Generalized Extreme Student Deviate Test <br>
...
.center[
```{r anomp,fig.width = 11, fig.height = 6.8,echo=FALSE,message = FALSE,warning = FALSE}
